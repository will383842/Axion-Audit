...
| 5.5 | **Créer une question ad hoc** depuis la zone question, type **échelle 1-5**, laisser la « Consigne (facultative) » **vide**, valider, puis l'afficher | le repli se lit « Aucune ancre de cotation n'est fournie pour cette question. » — jamais une ligne vide, jamais une invitation à « voir son ancre » ; le badge « ad hoc » est présent | A54, défauts R1 fermés · §32.4 ne garde que l'**admission en banque** (M1.1) : l'ad hoc est le seul chemin réel vers ce repli | photo | ☐ |
