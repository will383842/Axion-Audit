...
| `POST /v1/companies`                           | admin             | `createCompanyRequestSchema` → **201** `companyWriteResponseSchema`                           | **409 `COMPANY_DUPLICATE`** sur un SIREN déjà pris (décidé par l'index unique partiel, pas par une lecture préalable)                                                                                            |
| `GET /v1/companies/:id`                        | admin             | — → `companyResponseSchema`                                                                   | 404 si supprimée                                                                                                                                                                                                 |
| `PATCH /v1/companies/:id`                      | admin             | `updateCompanyRequestSchema` → `companyWriteResponseSchema`                                   | même 409 `COMPANY_DUPLICATE` ; rejoue R3/R4                                                                                                                                                                      |
